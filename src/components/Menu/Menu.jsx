          ...
          <div className="menu-container">
            ...
            {!isNormalMenuOpen && (
              <div className="menu-list-container">
                ...
                <MenuList label="Rice" food={banqRice} info="Pick 1 item from the menu below*"/>
                <MenuList label="Bread" food={banqBread} info="Pick 1 item from the menu below*"/>
                <MenuList label="Salad" food={banqSalad} />
                <MenuList label="Dessert" food={banqDessert} info="Pick 1 item from the menu below*"/>
              </div>
            )}
          </div>
        </section>
